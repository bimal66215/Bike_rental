# Forecasting hourly Bike rental demand for a Bike sharing systems.
...
In this project,we combined historical usage patterns with
weather data in order to forecast hourly bike rental demand.

Evaluation Metric used is RMSLE
